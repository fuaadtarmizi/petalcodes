  ...
  return (
    <>
     <Swiper
      ...
      >
        <SwiperSlide>
        <section className=" w-full rounded-md border" style={{background:'#4F6367'}}>
          ...
          <div>
            <div className="p-4">
              <p className="text-white">Thank you for PetalCode for providing me NFC Card Business. Now i can easily tap and go with my client to introduce my business</p>
            </div>
            <div>
            <Image 
              className=""
